    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-5 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard.commandes')" :active="request()->routeIs('dashboard.commandes')">
                        {{ __('Commandes') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-5 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard.fournisseurs')" :active="request()->routeIs('dashboard.fournisseurs')">
                        {{ __('Fournisseurs') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-5 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard.entree_stock')" :active="request()->routeIs('dashboard.entree_stock')">
                        {{ __('Entrées de stock') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-5 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard.sortie_stock')" :active="request()->routeIs('dashboard.sortie_stock')">
                        {{ __('Sortie de stock') }}
                    </x-nav-link>
                </div>
            </div>
