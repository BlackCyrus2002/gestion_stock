                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        produitSelect.addEventListener("change", function() {
                            ...
                            if (produitId) {
                                // Empêcher d'ajouter deux fois le même produit
                                if (document.querySelector(`#produit-${produitId}`)) {
                                ...
                                const produitHtml = `
                                    <div  id="produit-${produitId}">
                                        <input type="hidden" name="produits[${produitIndex}][id]" value="${produitId}">

                                        <div class="flex items-center gap-2">
                                            <label>Produits:  <strong>${produitNom}</strong></label>
                                            <button type="button" onclick="removeProduit(${produitId})" class="bg-red-500 text-white px-2 py-1 rounded">
                                                X
                                            </button>
                                        </div>
                                ...
                                produitIndex++; // Incrémenter l'index pour le prochain produit
                            }
                        });
                    });
